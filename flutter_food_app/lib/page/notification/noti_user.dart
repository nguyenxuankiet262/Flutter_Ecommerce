            ...
            builder: (context, ApiState apiState) {
              return !state.isLogin
                ...
                loadMore: apiState.mainUser == null
                    ? null
                    : apiState.mainUser.listFollowNotice == null
                    ? null
                    : () async {
                  if (await Helper().check()) {
                    if (apiState.mainUser.listFollowNotice.length ==
                        end) {
                      setState(() {
                        begin += 10;
                        end += 10;
                      });
                      await fetchFollowNotificaion(apiBloc, loadingBloc,
