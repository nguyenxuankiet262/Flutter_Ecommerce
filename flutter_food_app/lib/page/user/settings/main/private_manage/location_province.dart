...
class InfoProvincePage extends StatefulWidget {
  final Function changeProvince;
  final int indexCity;
  final int indexProvince;

  InfoProvincePage(this.changeProvince, this.indexCity, this.indexProvince);

  @override
  State<StatefulWidget> createState() => InfoProvincePageState();
}

class InfoProvincePageState extends State<InfoProvincePage> {
