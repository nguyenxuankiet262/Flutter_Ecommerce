    ...
    return BlocBuilder(
      ...
      builder: (context, ApiState state) {
        return Container(
            ...
            child: state.mainUser.listProducts == null
                ? Container(
                ...
                : StaggeredGridView.countBuilder(
                    ...
                    shrinkWrap: true,
                    itemCount: state.mainUser.listProducts.length,
                        ...
                        GestureDetector(
                                ...
                                Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        state.mainUser.listProducts[index].name,
                                        maxLines: 1,
                                    ...
                                    Padding(
                                      padding: EdgeInsets.only(
                                          ...
                                          top: 5.0),
                                      child: Text(
                                        state.mainUser.listProducts[index]
                                            .description,
                                        maxLines: 1,
                                        overflow: TextOverflow.ellipsis,
                                        style: TextStyle(
                          ...
                          onTap: () async {
                            if (await checkStatusProduct(
                                    state.mainUser.listProducts[index].id) ==
                                1) {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => Post(state
                                          .mainUser.listProducts[index].id)));
