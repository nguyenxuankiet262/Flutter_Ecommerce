                                      ...
                                      : () async {
                                          if (await Helper().check()) {
                                            if (searchState
                                              ...
                                              if (postManageBloc.currentState
                                                      .indexCategory ==
                                                  0) {
                                                print(loadmoreState.begin + 10);
                                                print(loadmoreState.end + 10);
                                                await searchProductsAllOfUser(
                                                ...
                                                if (postManageBloc.currentState
                                                        .indexChildCategory ==
                                                    0) {
                                                  await searchProductsOfMenuOfUser(
                                                      listSearchProductBloc,
                                                      loadingBloc,
                                                      apiBloc
                                                          .currentState
                                                      ...
                                                      postManageBloc
                                                          .currentState.code
                                                          .toString(),
                                                      postManageBloc.currentState.min
                                                          .toString(),
                                                      postManageBloc
                                                          .currentState.max
                                                          .toString(),
                                                  ...
                                                  await searchProductsOfChildMenuOfUser(
                                                      listSearchProductBloc,
                                                      loadingBloc,
                                                      apiBloc
                                                          .currentState
