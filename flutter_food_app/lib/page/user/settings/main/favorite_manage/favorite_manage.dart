...
class FavoriteManageState extends State<FavoriteManage>
  ...
  void initState() {
    ...
    _tabController =
    new TabController(vsync: this, length: tabsFavorite.length + 1);
  }
            ...
            return <Widget>[
              new SliverAppBar(
                ...
                bottom: new TabBar(
                  ...
                  tabs: new List.generate(tabsFavorite.length, (index) {
                    return new Tab(text: tabsFavorite[index].toUpperCase());
                  }),
