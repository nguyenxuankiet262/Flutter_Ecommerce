...
class CartItemState extends State<CartItem>{
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
        ...
        margin: EdgeInsets.only(top: 10.0, bottom: 5.0, right: 20.0, left: 20.0),
        child: Column(
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                Container(
                  margin: EdgeInsets.only(top: 15.0,left: 15.0, bottom: 5.0),
                ...
                Container(
                  width: 25,
                  height: 90,
                  margin: EdgeInsets.only(right: 15.0, top: 15.0, bottom: 10.0),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
