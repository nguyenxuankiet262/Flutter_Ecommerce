...
class _ListSearchPostState extends State<ListSearchPost>
  ...
  void initState() {
    ...
    detailBloc = BlocProvider.of<DetailPageBloc>(context);
                                                      ...
                                                      GestureDetector(
                                                          ...
                                                          child: Card(
                                                              ...
                                                              margin: EdgeInsets.only(
                                                                  ...
                                                                  top: 8,
                                                                  bottom: index ==
                                                                          searchState.listProduct.length -
                                                                              1
                                                                      ? 8.0
                                                                      : 0.0),
                                                              child: Column(
                                          ...
                                          : () async {
                                              if (await Helper().check()) {
                                                if (searchState
                                                  ...
                                                  if (detailBloc.currentState
                                                          .indexCategory ==
                                                      0) {
                                                    print(loadmoreState.begin +
                                                        10);
                                                    print(
                                                        loadmoreState.end + 10);
                                                    await searchProductsAll(
                                                    ...
                                                    if (detailBloc.currentState
                                                      ...
                                                      await searchProductsOfChildMenu(
                                                          listSearchProductBloc,
                                                          loadingBloc,
                                                          apiBloc
                                                              .currentState
