...
class RegisterCityPage extends StatefulWidget {
  ...
  RegisterCityPage(this.changeCity, this.index);

  @override
  State<StatefulWidget> createState() => RegisterCityPageState();
}

class RegisterCityPageState extends State<RegisterCityPage> {
